...
def on_overlap_tile25(sprite, location):
    global Map, Y_CheckPoint, X_CheckPoint, Reactor1
    tiles.set_tilemap(tilemap("""
    Map0
    """))
...
def on_overlap_tile26(sprite, location):
    global Map, Y_CheckPoint, X_CheckPoint, Reactor1
    tiles.set_tilemap(tilemap("""
    Map0
    """))
